...
class KnowledgeGraph(nn.Module):
    ...
    """
    def __init__(self, args, load_graph=True):
    ...
    def define_modules(self, use_init=False):
        if use_init is False:
            ...
            nn.init.xavier_normal_(self.entity_embeddings.weight[1:])
            ...
            nn.init.xavier_normal_(self.relation_embeddings.weight[1:])
            ...
            self.logger.info('Use pretrain relation embedding as relation embedding')
