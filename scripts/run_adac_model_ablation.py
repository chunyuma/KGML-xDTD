...
def train(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        while train_dataloader.has_next():
            ...
            # source_ids, target_ids = train_pairs[batch_path_id][:,0], train_pairs[batch_path_id][:,1]
        ...
        ## save the best model
        # if epoch > args.ac_update_delay and avg_hit > best_hit:
        if epoch > args.ac_update_delay:
            # best_hit = avg_hit
            # output
...
if __name__ == '__main__':
    ...
    ## folder parameters
    parser.add_argument("--log_dir", type=str, help="The path of logfile folder", default="~/explainable_DTD_ADAC_model/log_folder")
    parser.add_argument("--log_name", type=str, help="log file name", default="step11.log")
    parser.add_argument('--data_dir', type=str, help='Full path of data folder', default='~/explainable_DTD_ADAC_model/data')
    ...
    parser.add_argument("--output_folder", type=str, help="The path of output folder", default="~/explainable_DTD_ADAC_model/models")
    ...
    # parser.add_argument('--reward_shaping_threshold', type=float, help='Threshold cut off of reward shaping scores (default: 0.8)', default=0.8)
    ...
    ## create model folder
    folder_name = 'ADAC_model_ablation'
